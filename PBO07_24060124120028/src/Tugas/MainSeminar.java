 ...
 * Deskripsi : Kelas main dari Seminar yang merealisasikan polimorfisme inclusion dengan array statis.
...
public class MainSeminar {
    public static void main(String args[]) {
        ...
        D1 = new Dosen("Kahfi", "2006122620300817001");
        D2 = new Dosen("Renee", "2004082320300817002");

        M1 = new Mahasiswa("Faiq", "24060124130083", D1);
        M2 = new Mahasiswa("Jordan", "24060124120044", D2);
        M3 = new Mahasiswa("Haydar", "24060124120023", D1);
        M4 = new Mahasiswa("Mahes", "24060124140202", D2);
        M5 = new Mahasiswa("Menza", "2406024140138", D2);
